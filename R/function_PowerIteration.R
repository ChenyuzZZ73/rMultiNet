...
#' @name       PowerIteration
#' @param      tnsr adjacency tensor (n*n*L)
#' @param      ranks rank of core tensor
#' @param      U_0_list initialization
#' @param      delta1 reguliazation for mode1 and mode2
#' @param      delta2 reguliazation for mode3
#' @param      max_iter max times of iteration
