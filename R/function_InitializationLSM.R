###Function InitializationLSM:
###Input:
###      gen_list:adj_tensor, Theta
###      n: nodes
###      r:rank of U
###      M: the number of network types
###      pertub: the upper bound of Uniform distribution
###      int_type: way of initialize UW included "spec", "rand" and "warm"
###OUtput: list(adj_tensor,U_int, W_int, delta)
...
InitializationLSM <- function(gen_list, n, r, M, perturb = 0.1, int_type)
{
   ...
   initial_UW <- Init_UW(adj_tensor,n,r,M, Utrue_scaled, Wtrue, perturb, int_type)
