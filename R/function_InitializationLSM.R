...
#' @name       InitializationLSM
###Input:
#' @param      gen_list adj_tensor, Theta
#' @param      n  nodes
#' @param      r rank of U
#' @param      M the number of network types
#' @param      pertub  the upper bound of Uniform distribution
#' @param      int_type  way of initialize UW included "spec", "rand" and "warm"
#' @import     Matrix
#' @import     rTensor
#' @import     glmnet
#' @import    lpSolve
#' @import     matlabr
#' @import    truncnorm
#' @returns    list(adj_tensor,U_int, W_int, delta)
#' @export
...
InitializationLSM <- function(gen_list, n, rank, M, pertub = 0.1, int_type = "warm")
{
