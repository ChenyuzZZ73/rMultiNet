...
###Function GenerateLSM: generates latent space
###Input:
###      n: number of nodes
###      M: types of networks
###      d: rank of U matrix
###      L: number of layers
###      U_mean: the mean of U with the Norm distribution, sd = 1
###      cmax: the upper bound of C tensor
###      int_type: way of generating C tensor included "Uniform" and "Norm"
###      kernel_fun: way of generating the adjacency tensor included "logit" and "probit"
###      Pi_network_type: size of network types (default as 1/m, an m-dimensional vector)
###      scale_par: the scale parameter(default as 1)
