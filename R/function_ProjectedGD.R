###Function ProjectedGD:
###Input:
###      Ini_list: list(adj_tensor,U_int, W_int, delta) delta for incoherent parameters: (delta_1,delta_2,delta_3)
###      Cmax: upper bound
###      eta_outer: learning rate eta
###      tmax_outer: number of iterations in gradient descent
###      p_type: type of link function included "logit", "probit" and "poisson"
###      rd: if use stochastic sampling ("rand" or "Non")
###      scale_par: scale parameter (sigma in the paper)
###      sample_size
...
ProjectedGD <- function(Ini_list, Cmax, eta_outer = 1e-04,
